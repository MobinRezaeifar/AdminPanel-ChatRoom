  ...
  const submit = () => {
    if (UserNameUserRegisterList.includes(username)) {
      ...
      Toast.fire({
        ...
        html: `<a href="/" style="color:blue;text-decoration: underline;">Register</a>`,
      });
    }
  };
              ...
              <div className="form">
                ...
                <div className="links">
                  <p style={{color:"white"}}>
                    ...
                    <a rel="noopener noreferrer" href="/" className="" style={{color:"blue",borderBottom:"1px solid blue"}}>
                      Register
                    </a>
                  </p>
                </div>
